...
public class BottomBarTab extends FrameLayout {
    ...
    private int icon,mSicon;

    public BottomBarTab(Context context, @DrawableRes int icon, @DrawableRes int sicon, CharSequence title) {
        this(context, null, icon,sicon, title);
    }

    public BottomBarTab(Context context, AttributeSet attrs, int icon, @DrawableRes int sicon, CharSequence title) {
        this(context, attrs, 0, icon,sicon, title);
    }

    public BottomBarTab(Context context, AttributeSet attrs, int defStyleAttr, int icon, @DrawableRes int sicon, CharSequence title) {
        super(context, attrs, defStyleAttr);
        init(context, icon,sicon, title);
    }

    private void init(Context context, int icon,int sicon, CharSequence title) {
        mContext = context;
        this.icon=icon;
        this.mSicon=sicon;
        ...
        mTvTitle.setTextColor(ContextCompat.getColor(context,com.yq.common.R.color.tab_unselect));
        ...
        mTvUnreadCount.setBackgroundResource(com.yq.common.R.drawable.bg_msg_bubble);
